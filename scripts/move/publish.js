...
function extractAddressFromOutput(output) {
  const matches = output.match(/(?:Code was successfully deployed to object address|Successfully published package with address) (0x[0-9a-fA-F]+)/);
